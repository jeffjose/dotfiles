...
rm -rf ~/.vim/bundle/vim-pug
git clone git://github.com/digitaltoad/vim-pug.git ~/.vim/bundle/vim-pug

rm -rf ~/.vim/bundle/vim-svelte-plugin
git clone https://github.com/leafoftree/vim-svelte-plugin ~/.vim/bundle/vim-svelte-plugin
